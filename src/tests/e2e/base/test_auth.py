...
async def test_registration(
    http_client: AsyncClient, register_url: str, params: dict
) -> None:
...
async def test_login_user_does_not_exist(
    http_client: AsyncClient, login_url: str, params: dict
) -> None:
...
async def test_login_wrong_password(
    http_client: AsyncClient, register_url: str, login_url: str
) -> None:
    user = {
        "first_name": "Тест",
        "last_name": "Тесов",
